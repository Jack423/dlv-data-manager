...
@Slf4j
public class MealsView extends Composite<VerticalLayout> {
    ...
    private final Button createMealButton = new Button(
            "Create a New Meal",
    ...
    private void setupFooter() {
        createMealButton.addClickListener(event -> {
            UI.getCurrent().navigate(NewMealView.class);
        });

        buttonLayout.setWidthFull();
        buttonLayout.addClassNames(LumoUtility.Gap.MEDIUM);
        buttonLayout.add(createMealButton);
